...
public class SearchResultDTO {
    ...
    // Getters and Setters
    public Long getSamplePhraseId() { return samplePhraseId; }
    public void setSamplePhraseId(Long samplePhraseId) { this.samplePhraseId = samplePhraseId; }
